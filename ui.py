...
st.set_page_config(
    page_title="Darkk: AI-Powered Dark Web OSINT Tool",
    page_icon="🕵️‍♂️",
...
# Sidebar
st.sidebar.title("Darkk")
st.sidebar.text("AI-Powered Dark Web OSINT Tool")
st.sidebar.markdown(
    """Made by [Gagan](https://github.com/Gagan-Zeus/)"""
)
...
with logo_col:
    st.image(".github/assets/darkk_logo.png", width=200)
